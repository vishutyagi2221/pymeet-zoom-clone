    ...
    <div className="bg-premium min-h-screen text-white"><Navbar />
      <main className="mx-auto max-w-7xl px-4 py-8">
        ...
        <section className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
          <Card className="bg-gradient-to-br from-cyan-400/25 to-fuchsia-400/15 p-6"><div className="mb-8 flex h-14 w-14 items-center justify-center rounded-lg bg-cyan-300 text-slate-950"><Video size={28} /></div><h2 className="text-2xl font-bold">Create Meeting</h2><p className="mt-2 text-slate-300">Start a secure room with waiting room and host controls.</p><Link to="/create"><Button className="mt-6"><Plus size={18} /> Create button</Button></Link></Card>
